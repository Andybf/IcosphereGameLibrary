...
#include <Icosphere/Loaders/TextureLoader.hpp>
...
void setTextureParameters(int texType) {
    IC_TEST(glTexParameteri(texType, GL_TEXTURE_MIN_FILTER, GL_LINEAR));
    IC_TEST(glTexParameteri(texType, GL_TEXTURE_MAG_FILTER, GL_LINEAR));
